...
class Category(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether the category is currently active"
    )

    display_order = models.IntegerField(
        default=0,
        help_text="Order in which category appears (lower numbers first)"
    )
...
class Place(models.Model):
    ...
    is_approved = models.BooleanField(
        default=False,
        help_text="Whether the place has been approved by admin"
    )

    is_active = models.BooleanField(
        default=True,
        help_text="Whether the place is currently active"
    )
...
class PlaceImage(models.Model):
    ...
    is_primary = models.BooleanField(
        default=False,
        help_text="Whether this is the primary/main image for the place"
    )
...
class PlaceApproval(models.Model):
    ...
    comments = models.TextField(
        blank=True,
        help_text="Reviewer comments or feedback"
    )

    reviewed_at = models.DateTimeField(
        auto_now_add=True,
        help_text="When the review was conducted"
    )
