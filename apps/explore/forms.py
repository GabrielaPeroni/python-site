...
from .models import Place, PlaceImage, Category
...
class PlaceForm(forms.ModelForm):
    class Meta:
        model = Place
        fields = [
            'name', 'description', 'address', 'contact_phone', 
            'contact_email', 'contact_website', 'categories',
            'latitude', 'longitude'
        ]
        widgets = {
            ...
            'contact_website': forms.URLInput(attrs={
                'class': 'w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['categories'].queryset = Category.objects.filter(is_active=True).order_by('display_order')
    ...
    class Meta:
        ...
        widgets = {
            ...
            'is_primary': forms.CheckboxInput(attrs={
                'class': 'form-checkbox h-4 w-4 text-gray-900'
            }),
